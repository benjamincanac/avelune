...
| `threejs-lighting` | `new PointLight(color, 1, 100, 2)`-style intensities | Since r155 lights use physical units (candela); `1` is near-invisible | Start around 5–50 for point/spot lights (this project: torch `5`, Oracle glow `5`) |
