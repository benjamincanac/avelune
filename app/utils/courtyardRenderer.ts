...
export function createCourtyardRenderer(renderer: WebGLRenderer, scene: Scene, camera: Camera) {
  ...
  occlusion.render = (...args) => {
    scene.traverse((object) => {
      if ((object instanceof Sprite || object.name === 'courtyard-atmosphere' || object.userData.fountainSurface || object.userData.fountainCaustics || object.userData.waterRipple) && object.visible) {
